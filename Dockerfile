...
ENV DB_DATABASE=escogram_db
ENV DB_USERNAME=escortnearyou
ENV DB_PASSWORD=RkM$VbG,2%<=pWZHmjfhcT
ENV DB_HOST=escogram-db-instance.clwusksoe2n9.eu-north-1.rds.amazonaws.com
ENV DB_PORT=5432
...
ENV PAYMENT_REDIRECT_URL=${A_PAYMENT_REDIRECT_UR}
